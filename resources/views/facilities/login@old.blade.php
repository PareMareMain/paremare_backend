                ...
                <div class="col-lg-4">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <h4>Vendor Login</h4>
                            <form id="myform" method="post" action="{{route('vendor.login')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-danger btn-flat m-b-30 m-t-30" style="background: #42D8D4">Sign in</button>
                            </form>
                        </div>
                    </div>
                </div>
