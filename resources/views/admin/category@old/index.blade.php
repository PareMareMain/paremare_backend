                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('category.edit', $value->id) }}"
                                                        title="edit category"><i class="ti-pencil"
                                                            style="font-size: 15px;float:left;"></i></a>
                                                    <a href="#" title="delete category" class="delete" data-id="{{$value->id}}" data-url="{{route('category.delete',$value->id)}}"><i class="ti-trash" style="font-size: 15px;float:left;"></i></a>
